...
export default function NavBar(){
  const router = useRouter();
    return(
        <nav className="bg-gray-300 dark:bg-black p-4 flex justify-between items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 rounded-lg dark:bg-white p-2 hover:cursor-pointer" viewBox="0 0 512 104" onClick={()=>router.push('/')}>
            ...
            <section className="flex justify-center items-center">
              ...
              <section className="hidden sm:flex sm:justify-center sm:items-center sm:gap-5">
                ...
                <section className="flex gap-3 font-semibold">
                  ...
                  <button className="bg-white text-black py-2 px-4 rounded-full" onClick={()=>router.push('/login')}>
                    Login
                  </button>
                </section>
              </section>
