        ...
        <nav className="flex justify-between items-center w-full">
          ...
          <section className="flex items-center gap-3 px-4">
            ...
            <button
              ...
              className="bg-white hidden sm:block dark:bg-gray-800 border-2 border-black py-2 px-3 rounded-full dark:border-white"
            >
              Sign up
            </button>
            <button
      ...
      <footer className="bg-white dark:bg-[#171717] w-full flex justify-between p-1 items-center border-t-2 border-inherit dark:border-none">
        <section className="flex gap-1 p-1">
          <svg
            ...
            className="h-8 fill-current text-black dark:text-white"
            viewBox="0 0 100 100"
          >
